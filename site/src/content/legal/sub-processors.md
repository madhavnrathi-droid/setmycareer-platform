...
| 7 | **Application data storage** | **SetMyCareer Core API** (operated by us, not a third party) | Our own system of record for accounts, counselling sessions, counsellor notes and published reports | Account and profile data, contact details, assessment results, reports, session metadata | India [CONFIRM: hosting provider and region for api.setmycareer.com] |
